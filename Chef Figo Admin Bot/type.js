 ...
 * @property {(number|string)} chat_id Unique identifier for the target chat or username (in the format `@channelusername`).
 * @property {Action} action Type of action to broadcast.
 * @property {number} [message_thread_id] Unique identifier for the target message thread, only for messages in threads.
 ...
 * @property {function(string, ReplyOptions): Message} reply
 * @property {function(string, ReplyWithFormattedTextOptions): Message} replyWithHtml
 * @property {function(string, ReplyWithFormattedTextOptions): Message} replyWithMarkdown
 ...
 * @property {function(string, ReplyWithEditedMessageOptions): Message} replyWithEditedMessage - reply edited message to the current chat.
 *
 *
